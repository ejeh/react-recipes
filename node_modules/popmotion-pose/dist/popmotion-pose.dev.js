(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var pose = function (_a) {
        var transformPose = _a.transformPose, addListenerToValue = _a.addListenerToValue, extendAPI = _a.extendAPI, readValueFromSource = _a.readValueFromSource, posePriority = _a.posePriority;
        return poseFactory({
            ...
            startAction: function (_a, action$$1, complete) {
                var raw = _a.raw, setOnComplete = _a.setOnComplete;
                var reaction = {
                    update: function (v) { return raw.update(v); },
                    complete: function () {
                        complete();
                        if (setOnComplete)
                            raw.update(setOnComplete);
                    }
                };
    ...
    var convertPositionalUnits = function (state, pose) {
        ...
        positionalPoseKeys.forEach(function (key) {
            ...
            var toValueType = getValueType$2(pose[key]);
