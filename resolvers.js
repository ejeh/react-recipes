...
exports.resolvers = {
    ...
    Mutation: {
        ...
        addRecipe: async (root, { name, imageUrl, description, category, instructions,
        ...
        likeUserRecipe: async ( root, {_id, username}, {Recipe, User } )=> {
        ...
        unlikeUserRecipe: async ( root, {_id, username}, {Recipe, User } )=> {
